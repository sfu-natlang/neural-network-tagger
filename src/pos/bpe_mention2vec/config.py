...
class Config():
    ...
    # dataset
    dev_filename = "/cs/natlang-user/vivian/wsj-conll/dev.conllu_seg"
    test_filename = "/cs/natlang-user/vivian/wsj-conll/test.conllu_seg"
    train_filename = "/cs/natlang-user/vivian/wsj-conll/train.conllu_seg"
