...
class Config():
    ...
    dim = 100
    dim_char = 50
    glove_filename = "/cs/natlang-user/vivian/NeuroNER-master/data/word_vectors/glove.6B.100d.txt"
    
    # trimmed embeddings (created from glove_filename with build_data.py)
    trimmed_filename = "data/glove.6B.{}d.trimmed.npz".format(dim)

    # dataset
    dev_filename = "/cs/natlang-user/vivian/wsj-conll/dev.conllu"
    test_filename = "/cs/natlang-user/vivian/wsj-conll/test.conllu"
    train_filename = "/cs/natlang-user/vivian/wsj-conll/train.conllu"
